/* 
   quizzes.js - Contains the structured quiz data for Linux Domains
...
const quizzesData = {
    ...
    "auto_sdn": {
        ...
        "medium": [
            {
                ...
                options: ["Puppet", "Chef", "Ansible", "Linux DNA Center"],
                correct: 2,
                explanation: "الـ Ansible مشهور جداً بأنه Agentless، ويكتفي فقط بتفعيل הـ SSH على الراوتر أو السويتش ليدخل ويبرمجه."
            },
            {
                q: "ما هي بنية הـ (Intent-Based Networking) التي يقوم عليها הـ Linux DNA Center؟",
        ...
        "hard": [
            {
                q: "إذا كنت تريد كتابة סكريبت بايثون ليتحدث مع الـ SDN Controller (مثل Linux DNA Center) لاستخراج إحصائيات الشبكة. أي نوع من الـ APIs ستستخدم؟",
    ...
    "access_etherchannel": {
        ...
        "scenario": [
            {
                q: "أنت تقوم ببرمجة EtherChannel (LACP) بين سويتش Linux وسويتش Juniper. كتبت الأوامر، لكن القناة أصبحت (Suspended). ماذا تراجع أولاً؟",
                options: [
