...
if 'meth-content-oscp_bof' in content:
    print("Already injected content.")
    exit(0)
...
idx = content.find('<!-- Popup Modal structure')
if idx != -1:
    content = content[:idx] + content_injection + '\n\n' + content[idx:]
    with open(html_path, "w", encoding="utf-8") as f:
        f.write(content)
    print("Injected OSCP content successfully.")
else:
