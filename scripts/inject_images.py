...
tool_images = {
    ...
    'assetfinder': ['tool_assetfinder.png'],
    'chaos': ['tool_chaos.png'],
    'katana': ['tool_katana_1.png', 'tool_katana_2.png'],
    'hakrawler': ['tool_hakrawler.png'],
    'gospider': ['tool_gospider.png'],
    'gau': ['tool_gau_1.png'],
    'waybackurls': ['tool_gau_2.png'],
    'waymore': ['tool_gau_3.png'],
    'ffuf': ['tool_dir_1.png'],
    'feroxbuster': ['tool_dir_2.png'],
    'gobuster': ['tool_gobuster.png'],
    'dirsearch': ['category_dir.png'],
    'arjun': ['tool_param_1.png'],
    'paramspider': ['tool_param_2.png'],
    'linkfinder': ['tool_js_2.png'],
    'secretfinder': ['tool_js_3.png'],
    'nuclei': ['tool_vuln_1.png'],
    'dalfox': ['tool_vuln_2.png'],
    'sqlmap': ['tool_vuln_3.png'],
}
